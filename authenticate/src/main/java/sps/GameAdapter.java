...
import sps.ScissorPaperStone.Result;
import sps.ScissorPaperStone.Selection;
import sps.messages.ClientListMessage;
import sps.messages.GameMessage;
import sps.messages.SubscriptionMessage;
...
{	
	private Map<String, String> usernameToClientId;
	private ScissorPaperStone game;
...
//	    	Principal principal = SecurityContextHolder.getContext().getAuthentication();
    ...
    {   
        ...
        if (commandMessage.getOperation() == CommandMessage.SUBSCRIBE_OPERATION)
        {
        	...
        	subscribeUser( principal.getName(), clientId );         	
        }
        else if (commandMessage.getOperation() == CommandMessage.UNSUBSCRIBE_OPERATION)
        {
        	...
        	//unsubsribeUser( principal.getName(), clientId );
        }
